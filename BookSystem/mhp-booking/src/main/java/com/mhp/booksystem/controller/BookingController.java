...
public class BookingController {
    ...
    /** 商家数据看板统计（本月订单 + 评分），从 MerchantController 迁移过来 */
    @GetMapping("/stats/merchant")
    public Result<MerchantStatsVO> getMerchantStats() {
        return Result.ok(bookingService.getMerchantStats());
    }
}
